...
public class TouchEffectAnimator {
    ...
    private final int EASE_ANIM_DURATION = 100;
    private final int RIPPLE_ANIM_DURATION = 200;
    ...
    public void onDraw(final Canvas canvas) {
        ...
        if (hasRippleEffect) {
            mCirclePath.reset();
            mCirclePaint.setAlpha(mCircleAlpha);
            mCirclePath.addRect(new RectF(0, 0, mView.getWidth(), mView.getHeight()), Path.Direction.CW);
        ...
        mRectPaint.setAlpha(mRectAlpha);
        canvas.drawRect(new RectF(0, 0, mView.getWidth(), mView.getHeight()), mRectPaint);
    }
